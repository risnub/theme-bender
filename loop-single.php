            ...
            <div class="listing-data">
                <div class="listing-basicinfo">
                    ...
                    <div class="listing-attributes">
                        ...
                        <span class="location"><?php echo __(osc_item_city(), 'DB_Values'); ?> <?php if( osc_item_region()!='' ) { ?> (<?php echo __(osc_item_region(), DB_Values); ?>)<?php } ?></span> <span class="g-hide">-</span> <?php echo osc_format_date(osc_item_pub_date()); ?>
